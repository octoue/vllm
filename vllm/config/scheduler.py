...
class SchedulerConfig:
    ...
    """Defer prefetch when free_blocks < this value.
    Applies independently of PCIe scheduling mode to protect active inference.
    测试数据显示82-100 free_blocks时发生allocation失败，提高到150保证安全裕度"""

    max_prefetch_block_ratio: float = Field(default=0.3, ge=0.0, le=1.0)
    """Maximum ratio of total GPU blocks that can be occupied by prefetch
